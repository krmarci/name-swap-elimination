    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-girl mb-4">Vote on Girl Names</h1>
          ...
          {namePair ? (
            <>
              <Button
                ...
                className="bg-girl hover:bg-girl-dark text-white w-full md:w-5/12 h-32 md:h-64 text-2xl md:text-4xl font-bold rounded-xl transition-all duration-200 transform hover:scale-105"
              >
                {namePair[0].name}
              </Button>
